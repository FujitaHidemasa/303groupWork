...
const characters = {
    'abdul': createChar('アブドゥル・ハッサン','images/char/アブドゥルメイン.jpeg','images/char/アブドゥルバナー.jpg','エジプト','サポート',
    ...
    'wolf': createChar('ヴォルフ・ヴァイスマン','images/char/ヴォルフメイン.jpeg','images/char/ヴォルフ・ヴァイスマン バナー.jpg','ドイツ','タンク',
    ...
    'sota': createChar('界守 颯太','images/char/ソウタメイン.jpeg','images/char/ソウタバナー.jpg','日本','アタッカー（近接）',
    ...
    'gaby': createChar('ガブリエル・オルテガ','images/char/ガブリエルメイン.jpg','images/char/ガブリエルバナー.jpg','ブラジル','アタッカー（近接）',
    ...
    'zeroone': createChar('ゼロ・ワン','images/char/ゼロ・ワンメイン.jpeg','images/char/ゼロ・ワン バナー.jpg','出自不明','アタッカー（近接）',
    ...
    'echo': createChar('エコー','images/char/エコーメイン.jpeg','images/char/エコー バナー.jpg','北米の古い森','アタッカー（中・遠距離）',
    ...
    'kai': createChar('カイ・スパーク・リチャーズ','images/charカイメイン.jpeg','images/char/カイ・スパーク・リチャーズ バナー.jpg','イギリス','近接',
    ...
    'lia': createChar('リア・チャン','images/char/リアメイン.jpeg','images/char/リア・チャン バナー.jpg','中国','サポーター',
    ...
    'picco': createChar('ピコ','images/char/ピコメイン.jpeg','images/char/ピコバナー.jpg','境界の狭間（異世界）','サポーター',
    ...
    'raj': createChar('ラジャ・サルカール','images/char/ラジャメイン.jpg','images/char/ラジャ・サルカール バナー.jpg','インド','アタッカー（遠距離）',
    ...
    'fudou': createChar('フドウ','images/char/フドウメイン.jpeg','images/char/フドウ バナー.jpg','極寒の荒野（異世界）','アタッカー（近接）',
    ...
    'nightmare': createChar('ナイトメア','images/char/ナイトメアメイン.jpeg','images/char/ナイトメアバナー.jpg','逢魔時（異世界）','アタッカー（中・近接）',
    ...
    'valner': createChar('ヴァルナー','images/charヴァルナーメイン.jpg','images/char/ヴァルナー バナー.jpg','宇宙の深淵（異世界）','アタッカー（近接）',
    ...
    'celine': createChar('セリーヌ・デュボア','images/char/セリーヌメイン.jpeg','images/char/セリーヌ・デュボア バナー.jpg','フランス','アタッカー（遠距離）',
