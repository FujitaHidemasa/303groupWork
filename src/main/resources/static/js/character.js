...
const characters = {
    'abdul': createChar('アブドゥル・ハッサン','images/abdulMain.jpeg','images/abdulBanner.jpg','エジプト','サポート',
    ...
    'wolf': createChar('ヴォルフ・ヴァイスマン','images/ヴォルフメイン.jpeg','images/ヴォルフ・ヴァイスマン バナー.jpg','ドイツ','タンク',
    ...
    'sota': createChar('界守 颯太','images/ソウタメイン.jpeg','images/ソウタバナー.jpg','日本','アタッカー（近接）',
    ...
    'gaby': createChar('ガブリエル・オルテガ','images/ガブリエルメイン.jpg','images/ガブリエルバナー.jpg','ブラジル','アタッカー（近接）',
    ...
    'zeroone': createChar('ゼロ・ワン','images/ゼロ・ワンメイン.jpeg','images/ゼロ・ワン バナー.jpg','出自不明','アタッカー（近接）',
    ...
    'echo': createChar('エコー','images/エコーメイン.jpeg','images/エコー バナー.jpg','北米の古い森','アタッカー（中・遠距離）',
    ...
    'kai': createChar('カイ・スパーク・リチャーズ','images/カイメイン.jpeg','images/カイ・スパーク・リチャーズ バナー.jpg','イギリス','近接',
    ...
    'lia': createChar('リア・チャン','images/リアメイン.jpeg','images/リア・チャン バナー.jpg','中国','サポーター',
    ...
    'picco': createChar('ピコ','images/ピコメイン.jpeg','images/ピコバナー.jpg','境界の狭間（異世界）','サポーター',
    ...
    'raj': createChar('ラジャ・サルカール','images/ラジャメイン.jpg','images/ラジャ・サルカール バナー.jpg','インド','アタッカー（遠距離）',
    ...
    'fudou': createChar('フドウ','images/フドウメイン.jpeg','images/フドウ バナー.jpg','極寒の荒野（異世界）','アタッカー（近接）',
    ...
    'nightmare': createChar('ナイトメア','images/ナイトメアメイン.jpeg','images/ナイトメアバナー.jpg','逢魔時（異世界）','アタッカー（中・近接）',
    ...
    'valner': createChar('ヴァルナー','images/ヴァルナーメイン.jpg','images/ヴァルナー バナー.jpg','宇宙の深淵（異世界）','アタッカー（近接）',
    ...
    'celine': createChar('セリーヌ・デュボア','images/セリーヌメイン.jpeg','images/セリーヌ・デュボア バナー.jpg','フランス','アタッカー（遠距離）',
